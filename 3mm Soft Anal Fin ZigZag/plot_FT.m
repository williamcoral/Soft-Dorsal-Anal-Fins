...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
time_125 = 0:1/1000:11788/1000-1/1000;
time_150 = 0:1/1000:11345/1000-1/1000;
time_175 = 0:1/1000:11231/1000-1/1000;
time_200 = 0:1/1000:11161/1000-1/1000;
time_225 = 0:1/1000:11115/1000-1/1000;
time_250 = 0:1/1000:11085/1000-1/1000;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(1);
...
legend('boxoff')
xlabel('Time (S)','FontSize',16,'FontWeight','bold')
ylabel('Torque Tx/Ty/Tz (N mm)','FontSize',16,'FontWeight','bold')
set(gca,'FontSize',16)
%title('Torque X')
xlim([0 10])
grid on
